...
def train(train_set,model,learning_rate,SGD=True,print_training=False):
    """
...
def main(args):
    ...
    for i in range(epoches):
        start = time.time()
        train_acc=train(train_set,model,args.learning_rate,args.SGD)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--SGD', type=bool, default=False,
                          help='use SGD to do the optimization')
